    ...
    return (
        <div className="flex items-center justify-between border-b p-4 last:border-b-0">
            <div className="flex items-center gap-4">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                        {t("Ditambahkan")} {passkey.created_at_diff}
                        {passkey.last_used_at_diff && (
                            <>
                                <span className="mx-1 text-muted-foreground/50">
                                    /
                                </span>
                                {t("Terakhir digunakan")} {passkey.last_used_at_diff}
                            </>
                        )}
                    </p>
                </div>
            ...
            <Dialog>
                ...
                <DialogContent>
                    <DialogTitle>{t("Hapus passkey")}</DialogTitle>
                    <DialogDescription>
                        {t("Hapus passkey “")}{passkey.name}{t("”? Anda tidak dapat lagi menggunakannya untuk masuk.")}
                    </DialogDescription>
                    <DialogFooter className="gap-2">
                        ...
                        <Button
                            ...
                            disabled={isDeleting}
                        >
                            {t(isDeleting ? 'Menghapus...' : 'Hapus passkey')}
                        </Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
