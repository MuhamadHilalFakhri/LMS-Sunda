...
export default function Security(props: Props) {
    ...
    return (
        <>
            ...
            <h1 className="sr-only">{t("Keamanan akun")}</h1>

            <div className="surface space-y-6 p-6 md:p-7">
                <Heading
                    variant="small"
                    title={t("Ubah kata sandi")}
                    description={t("Gunakan kata sandi yang kuat dan tidak digunakan di tempat lain")}
                />
